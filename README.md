...
`src/minizero/integrations/lichess_bot_adapter.py` adapts the neural engine family to a Lichess-bot style move-selection interface, including support for restricted root-move sets from books/tablebases.

Authentication credentials are **not** part of this repository.
